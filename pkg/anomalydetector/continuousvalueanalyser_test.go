...
func TestContinuousValueDeviationAnalyser_GetPodsOutOfBounds(t *testing.T) {
	...
	type fields struct {
		ContinuousValueDeviation v1alpha1.ContinuousValueDeviation
	...
	tests := []struct {
	...
	}{
		{
			name: "analysis error",
			fields: fields{
				ContinuousValueDeviation: *v1alpha1.DefaultContinuousValueDeviation(&v1alpha1.ContinuousValueDeviation{}),
				selector:                 nil,
		...
		},
		{
			...
			fields: fields{
				ContinuousValueDeviation: *v1alpha1.DefaultContinuousValueDeviation(&v1alpha1.ContinuousValueDeviation{MaxDeviationPercent: v1alpha1.NewFloat64(50.0)}),
				selector:                 labels.Everything(),
				analyser: &testContinuousValueAnalyser{
					deviationByPodName: deviationByPodName{
						"A": 1.1,
